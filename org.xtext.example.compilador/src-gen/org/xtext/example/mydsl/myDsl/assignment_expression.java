...
public interface assignment_expression extends EObject
{
   ...
   * @see #setAssignment_operator(assignment_operator)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getassignment_expression_Assignment_operator()
   * @model containment="true"
   * @generated
   */
  assignment_operator getAssignment_operator();

  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.assignment_expression#getAssignment_operator <em>Assignment operator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setAssignment_operator(assignment_operator value);
