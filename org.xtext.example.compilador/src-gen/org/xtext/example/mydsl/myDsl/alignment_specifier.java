 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.alignment_specifier#getAlignas <em>Alignas</em>}</li>
...
{
  /**
   * Returns the value of the '<em><b>Alignas</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Alignas</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Alignas</em>' attribute.
   * @see #setAlignas(String)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getalignment_specifier_Alignas()
   * @model
   * @generated
   */
  String getAlignas();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.alignment_specifier#getAlignas <em>Alignas</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Alignas</em>' attribute.
   * @see #getAlignas()
   * @generated
   */
  void setAlignas(String value);
