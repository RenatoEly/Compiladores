 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.generic_selection#getGeneric <em>Generic</em>}</li>
...
public interface generic_selection extends EObject
{
   ...
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getgeneric_selection_Generic()
   * @model
   * @generated
   */
  String getGeneric();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.generic_selection#getGeneric <em>Generic</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the value of the '<em><b>Generic assoc list</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Generic assoc list</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Generic assoc list</em>' containment reference.
   * @see #setGeneric_assoc_list(generic_assoc_list)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getgeneric_selection_Generic_assoc_list()
   * @model containment="true"
   * @generated
   */
  generic_assoc_list getGeneric_assoc_list();

  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.generic_selection#getGeneric_assoc_list <em>Generic assoc list</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Generic assoc list</em>' containment reference.
   * @see #getGeneric_assoc_list()
   * @generated
   */
  void setGeneric_assoc_list(generic_assoc_list value);
