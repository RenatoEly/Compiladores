...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>additive expression2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.additive_expression2Impl#getMultiplicative_expression <em>Multiplicative expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.additive_expression2Impl#getAdditive_expression2 <em>Additive expression2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class additive_expression2Impl extends MinimalEObjectImpl.Container implements additive_expression2
{
  /**
   ...
   * @generated
   */
  protected additive_expression2Impl()
  {
    super();
  }
  ...
  {
    return MyDslPackage.Literals.ADDITIVE_EXPRESSION2;
  }
  ...
  public NotificationChain basicSetMultiplicative_expression(multiplicative_expression newMultiplicative_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ADDITIVE_EXPRESSION2__MULTIPLICATIVE_EXPRESSION, oldMultiplicative_expression, newMultiplicative_expression);
  ...
  public void setMultiplicative_expression(multiplicative_expression newMultiplicative_expression)
  {
    if (newMultiplicative_expression != multiplicative_expression)
    {
      ...
      if (multiplicative_expression != null)
        msgs = ((InternalEObject)multiplicative_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ADDITIVE_EXPRESSION2__MULTIPLICATIVE_EXPRESSION, null, msgs);
      if (newMultiplicative_expression != null)
        msgs = ((InternalEObject)newMultiplicative_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ADDITIVE_EXPRESSION2__MULTIPLICATIVE_EXPRESSION, null, msgs);
      msgs = basicSetMultiplicative_expression(newMultiplicative_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ADDITIVE_EXPRESSION2__MULTIPLICATIVE_EXPRESSION, newMultiplicative_expression, newMultiplicative_expression));
  }
  ...
  public NotificationChain basicSetAdditive_expression2(additive_expression2 newAdditive_expression2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ADDITIVE_EXPRESSION2__ADDITIVE_EXPRESSION2, oldAdditive_expression2, newAdditive_expression2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAdditive_expression2(additive_expression2 newAdditive_expression2)
  {
    if (newAdditive_expression2 != additive_expression2)
    {
      ...
      if (additive_expression2 != null)
        msgs = ((InternalEObject)additive_expression2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ADDITIVE_EXPRESSION2__ADDITIVE_EXPRESSION2, null, msgs);
      if (newAdditive_expression2 != null)
        msgs = ((InternalEObject)newAdditive_expression2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ADDITIVE_EXPRESSION2__ADDITIVE_EXPRESSION2, null, msgs);
      msgs = basicSetAdditive_expression2(newAdditive_expression2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ADDITIVE_EXPRESSION2__ADDITIVE_EXPRESSION2, newAdditive_expression2, newAdditive_expression2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.ADDITIVE_EXPRESSION2__MULTIPLICATIVE_EXPRESSION:
        return basicSetMultiplicative_expression(null, msgs);
      case MyDslPackage.ADDITIVE_EXPRESSION2__ADDITIVE_EXPRESSION2:
