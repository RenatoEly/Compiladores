 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.exclusive_or_expressionImpl#getExclusive_or_expression2 <em>Exclusive or expression2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class exclusive_or_expressionImpl extends MinimalEObjectImpl.Container implements exclusive_or_expression
{
  ...
  public NotificationChain basicSetExclusive_or_expression2(exclusive_or_expression2 newExclusive_or_expression2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION2, oldExclusive_or_expression2, newExclusive_or_expression2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setExclusive_or_expression2(exclusive_or_expression2 newExclusive_or_expression2)
  {
    if (newExclusive_or_expression2 != exclusive_or_expression2)
    {
      ...
      if (exclusive_or_expression2 != null)
        msgs = ((InternalEObject)exclusive_or_expression2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION2, null, msgs);
      if (newExclusive_or_expression2 != null)
        msgs = ((InternalEObject)newExclusive_or_expression2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION2, null, msgs);
      msgs = basicSetExclusive_or_expression2(newExclusive_or_expression2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION2, newExclusive_or_expression2, newExclusive_or_expression2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.EXCLUSIVE_OR_EXPRESSION__EXCLUSIVE_OR_EXPRESSION2:
