...
public class compound_statementImpl extends MinimalEObjectImpl.Container implements compound_statement
{
   ...
   * @ordered
   */
  protected EList<block_item> block_item_list;
   ...
   * @generated
   */
  public EList<block_item> getBlock_item_list()
  {
    if (block_item_list == null)
    {
      block_item_list = new EObjectContainmentEList<block_item>(block_item.class, this, MyDslPackage.COMPOUND_STATEMENT__BLOCK_ITEM_LIST);
    }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case MyDslPackage.COMPOUND_STATEMENT__BLOCK_ITEM_LIST:
        ...
        getBlock_item_list().addAll((Collection<? extends block_item>)newValue);
        return;
    }
