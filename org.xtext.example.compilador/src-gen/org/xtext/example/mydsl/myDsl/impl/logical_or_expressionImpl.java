 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.logical_or_expressionImpl#getLogical_or_expression2 <em>Logical or expression2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class logical_or_expressionImpl extends MinimalEObjectImpl.Container implements logical_or_expression
{
  ...
  public NotificationChain basicSetLogical_or_expression2(logical_or_expression2 newLogical_or_expression2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.LOGICAL_OR_EXPRESSION__LOGICAL_OR_EXPRESSION2, oldLogical_or_expression2, newLogical_or_expression2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setLogical_or_expression2(logical_or_expression2 newLogical_or_expression2)
  {
    if (newLogical_or_expression2 != logical_or_expression2)
    {
      ...
      if (logical_or_expression2 != null)
        msgs = ((InternalEObject)logical_or_expression2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOGICAL_OR_EXPRESSION__LOGICAL_OR_EXPRESSION2, null, msgs);
      if (newLogical_or_expression2 != null)
        msgs = ((InternalEObject)newLogical_or_expression2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.LOGICAL_OR_EXPRESSION__LOGICAL_OR_EXPRESSION2, null, msgs);
      msgs = basicSetLogical_or_expression2(newLogical_or_expression2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.LOGICAL_OR_EXPRESSION__LOGICAL_OR_EXPRESSION2, newLogical_or_expression2, newLogical_or_expression2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.LOGICAL_OR_EXPRESSION__LOGICAL_OR_EXPRESSION2:
