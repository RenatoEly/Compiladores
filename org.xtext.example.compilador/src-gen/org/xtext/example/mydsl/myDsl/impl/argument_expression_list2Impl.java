...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>argument expression list2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.argument_expression_list2Impl#getAssignment_expression <em>Assignment expression</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.argument_expression_list2Impl#getArgument_expression_list2 <em>Argument expression list2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class argument_expression_list2Impl extends MinimalEObjectImpl.Container implements argument_expression_list2
{
  /**
   ...
   * @generated
   */
  protected argument_expression_list2Impl()
  {
    super();
  }
  ...
  {
    return MyDslPackage.Literals.ARGUMENT_EXPRESSION_LIST2;
  }
  ...
  public NotificationChain basicSetAssignment_expression(assignment_expression newAssignment_expression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ASSIGNMENT_EXPRESSION, oldAssignment_expression, newAssignment_expression);
  ...
  public void setAssignment_expression(assignment_expression newAssignment_expression)
  {
    if (newAssignment_expression != assignment_expression)
    {
      ...
      if (assignment_expression != null)
        msgs = ((InternalEObject)assignment_expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ASSIGNMENT_EXPRESSION, null, msgs);
      if (newAssignment_expression != null)
        msgs = ((InternalEObject)newAssignment_expression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ASSIGNMENT_EXPRESSION, null, msgs);
      msgs = basicSetAssignment_expression(newAssignment_expression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ASSIGNMENT_EXPRESSION, newAssignment_expression, newAssignment_expression));
  }
  ...
  public NotificationChain basicSetArgument_expression_list2(argument_expression_list2 newArgument_expression_list2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ARGUMENT_EXPRESSION_LIST2, oldArgument_expression_list2, newArgument_expression_list2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setArgument_expression_list2(argument_expression_list2 newArgument_expression_list2)
  {
    if (newArgument_expression_list2 != argument_expression_list2)
    {
      ...
      if (argument_expression_list2 != null)
        msgs = ((InternalEObject)argument_expression_list2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ARGUMENT_EXPRESSION_LIST2, null, msgs);
      if (newArgument_expression_list2 != null)
        msgs = ((InternalEObject)newArgument_expression_list2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ARGUMENT_EXPRESSION_LIST2, null, msgs);
      msgs = basicSetArgument_expression_list2(newArgument_expression_list2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ARGUMENT_EXPRESSION_LIST2, newArgument_expression_list2, newArgument_expression_list2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ASSIGNMENT_EXPRESSION:
        return basicSetAssignment_expression(null, msgs);
      case MyDslPackage.ARGUMENT_EXPRESSION_LIST2__ARGUMENT_EXPRESSION_LIST2:
