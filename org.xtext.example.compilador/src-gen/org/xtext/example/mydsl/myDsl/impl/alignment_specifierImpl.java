 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.alignment_specifierImpl#getAlignas <em>Alignas</em>}</li>
...
{
  /**
   * The default value of the '{@link #getAlignas() <em>Alignas</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getAlignas()
   * @generated
   * @ordered
   */
  protected static final String ALIGNAS_EDEFAULT = null;

  /**
   * The cached value of the '{@link #getAlignas() <em>Alignas</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getAlignas()
   * @generated
   * @ordered
   */
  protected String alignas = ALIGNAS_EDEFAULT;
   ...
   * @generated
   */
  public void setAlignas(String newAlignas)
  {
    String oldAlignas = alignas;
    alignas = newAlignas;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ALIGNMENT_SPECIFIER__ALIGNAS, oldAlignas, alignas));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.ALIGNMENT_SPECIFIER__ALIGNAS:
        return getAlignas();
      case MyDslPackage.ALIGNMENT_SPECIFIER__TYPE_NAME:
        return getType_name();
      case MyDslPackage.ALIGNMENT_SPECIFIER__CONSTANT_EXPRESSION:
  ...
  public boolean eIsSet(int featureID)
  {
    ...
    {
      case MyDslPackage.ALIGNMENT_SPECIFIER__ALIGNAS:
        return ALIGNAS_EDEFAULT == null ? alignas != null : !ALIGNAS_EDEFAULT.equals(alignas);
      case MyDslPackage.ALIGNMENT_SPECIFIER__TYPE_NAME:
