...
public class assignment_expressionImpl extends MinimalEObjectImpl.Container implements assignment_expression
{
  ...
  /**
   * The cached value of the '{@link #getAssignment_operator() <em>Assignment operator</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  protected assignment_operator assignment_operator;
   ...
   * @generated
   */
  public NotificationChain basicSetAssignment_operator(assignment_operator newAssignment_operator, NotificationChain msgs)
  {
    assignment_operator oldAssignment_operator = assignment_operator;
    assignment_operator = newAssignment_operator;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_OPERATOR, oldAssignment_operator, newAssignment_operator);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   * @generated
   */
  public void setAssignment_operator(assignment_operator newAssignment_operator)
  {
    if (newAssignment_operator != assignment_operator)
    {
      NotificationChain msgs = null;
      if (assignment_operator != null)
        msgs = ((InternalEObject)assignment_operator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_OPERATOR, null, msgs);
      if (newAssignment_operator != null)
        msgs = ((InternalEObject)newAssignment_operator).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_OPERATOR, null, msgs);
      msgs = basicSetAssignment_operator(newAssignment_operator, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_OPERATOR, newAssignment_operator, newAssignment_operator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_OPERATOR:
        return basicSetAssignment_operator(null, msgs);
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.ASSIGNMENT_EXPRESSION__UNARY_EXPRESSION:
        ...
        return;
      case MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_OPERATOR:
        setAssignment_operator((assignment_operator)newValue);
        return;
      case MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_EXPRESSION:
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.ASSIGNMENT_EXPRESSION__UNARY_EXPRESSION:
        ...
        return;
      case MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_OPERATOR:
        setAssignment_operator((assignment_operator)null);
        return;
      case MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_EXPRESSION:
  ...
  public boolean eIsSet(int featureID)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_OPERATOR:
        return assignment_operator != null;
      case MyDslPackage.ASSIGNMENT_EXPRESSION__ASSIGNMENT_EXPRESSION:
