 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.inclusive_or_expressionImpl#getInclusive_or_expression2 <em>Inclusive or expression2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class inclusive_or_expressionImpl extends MinimalEObjectImpl.Container implements inclusive_or_expression
{
  ...
  public NotificationChain basicSetInclusive_or_expression2(inclusive_or_expression2 newInclusive_or_expression2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION2, oldInclusive_or_expression2, newInclusive_or_expression2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setInclusive_or_expression2(inclusive_or_expression2 newInclusive_or_expression2)
  {
    if (newInclusive_or_expression2 != inclusive_or_expression2)
    {
      ...
      if (inclusive_or_expression2 != null)
        msgs = ((InternalEObject)inclusive_or_expression2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION2, null, msgs);
      if (newInclusive_or_expression2 != null)
        msgs = ((InternalEObject)newInclusive_or_expression2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION2, null, msgs);
      msgs = basicSetInclusive_or_expression2(newInclusive_or_expression2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION2, newInclusive_or_expression2, newInclusive_or_expression2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.INCLUSIVE_OR_EXPRESSION__INCLUSIVE_OR_EXPRESSION2:
