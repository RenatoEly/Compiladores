 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.struct_declarator_listImpl#getStruct_declarator_list2 <em>Struct declarator list2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class struct_declarator_listImpl extends MinimalEObjectImpl.Container implements struct_declarator_list
{
  ...
  public NotificationChain basicSetStruct_declarator_list2(struct_declarator_list2 newStruct_declarator_list2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST2, oldStruct_declarator_list2, newStruct_declarator_list2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setStruct_declarator_list2(struct_declarator_list2 newStruct_declarator_list2)
  {
    if (newStruct_declarator_list2 != struct_declarator_list2)
    {
      ...
      if (struct_declarator_list2 != null)
        msgs = ((InternalEObject)struct_declarator_list2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST2, null, msgs);
      if (newStruct_declarator_list2 != null)
        msgs = ((InternalEObject)newStruct_declarator_list2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST2, null, msgs);
      msgs = basicSetStruct_declarator_list2(newStruct_declarator_list2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST2, newStruct_declarator_list2, newStruct_declarator_list2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.STRUCT_DECLARATOR_LIST__STRUCT_DECLARATOR_LIST2:
