 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.init_declarator_listImpl#getInit_declarator_list2 <em>Init declarator list2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class init_declarator_listImpl extends MinimalEObjectImpl.Container implements init_declarator_list
{
  ...
  public NotificationChain basicSetInit_declarator_list2(init_declarator_list2 newInit_declarator_list2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST2, oldInit_declarator_list2, newInit_declarator_list2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setInit_declarator_list2(init_declarator_list2 newInit_declarator_list2)
  {
    if (newInit_declarator_list2 != init_declarator_list2)
    {
      ...
      if (init_declarator_list2 != null)
        msgs = ((InternalEObject)init_declarator_list2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST2, null, msgs);
      if (newInit_declarator_list2 != null)
        msgs = ((InternalEObject)newInit_declarator_list2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST2, null, msgs);
      msgs = basicSetInit_declarator_list2(newInit_declarator_list2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST2, newInit_declarator_list2, newInit_declarator_list2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.INIT_DECLARATOR_LIST__INIT_DECLARATOR_LIST2:
