 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.direct_abstract_declaratorImpl#getStatic <em>Static</em>}</li>
...
public class direct_abstract_declaratorImpl extends MinimalEObjectImpl.Container implements direct_abstract_declarator
{
  ...
  public NotificationChain basicSetDirect_abstract_declarator2(direct_abstract_declarator2 newDirect_abstract_declarator2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.DIRECT_ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR2, oldDirect_abstract_declarator2, newDirect_abstract_declarator2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setDirect_abstract_declarator2(direct_abstract_declarator2 newDirect_abstract_declarator2)
  {
    if (newDirect_abstract_declarator2 != direct_abstract_declarator2)
    {
      ...
      if (direct_abstract_declarator2 != null)
        msgs = ((InternalEObject)direct_abstract_declarator2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.DIRECT_ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR2, null, msgs);
      if (newDirect_abstract_declarator2 != null)
        msgs = ((InternalEObject)newDirect_abstract_declarator2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.DIRECT_ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR2, null, msgs);
      msgs = basicSetDirect_abstract_declarator2(newDirect_abstract_declarator2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.DIRECT_ABSTRACT_DECLARATOR__DIRECT_ABSTRACT_DECLARATOR2, newDirect_abstract_declarator2, newDirect_abstract_declarator2));
  }
  ...
  public void setStatic(String newStatic)
  {
    ...
    static_ = newStatic;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.DIRECT_ABSTRACT_DECLARATOR__STATIC, oldStatic, static_));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.DIRECT_ABSTRACT_DECLARATOR__STATIC:
        return getStatic();
      case MyDslPackage.DIRECT_ABSTRACT_DECLARATOR__TYPE_QUALIFIER_LIST:
