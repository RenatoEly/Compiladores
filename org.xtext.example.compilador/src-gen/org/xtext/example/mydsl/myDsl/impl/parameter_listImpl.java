 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.parameter_listImpl#getParameter_list2 <em>Parameter list2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class parameter_listImpl extends MinimalEObjectImpl.Container implements parameter_list
{
  ...
  public NotificationChain basicSetParameter_list2(parameter_list2 newParameter_list2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.PARAMETER_LIST__PARAMETER_LIST2, oldParameter_list2, newParameter_list2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setParameter_list2(parameter_list2 newParameter_list2)
  {
    if (newParameter_list2 != parameter_list2)
    {
      ...
      if (parameter_list2 != null)
        msgs = ((InternalEObject)parameter_list2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.PARAMETER_LIST__PARAMETER_LIST2, null, msgs);
      if (newParameter_list2 != null)
        msgs = ((InternalEObject)newParameter_list2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.PARAMETER_LIST__PARAMETER_LIST2, null, msgs);
      msgs = basicSetParameter_list2(newParameter_list2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.PARAMETER_LIST__PARAMETER_LIST2, newParameter_list2, newParameter_list2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case MyDslPackage.PARAMETER_LIST__PARAMETER_LIST2:
