 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.primary_expression#getString <em>String</em>}</li>
...
public interface primary_expression extends EObject
{
   ...
   * @see #setIdentifier(direct_declarator)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getprimary_expression_Identifier()
   * @model
   * @generated
   */
  direct_declarator getIdentifier();

  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.primary_expression#getIdentifier <em>Identifier</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setIdentifier(direct_declarator value);
   ...
   * @see #setString(string_nova)
   * @see org.xtext.example.mydsl.myDsl.MyDslPackage#getprimary_expression_String()
   * @model containment="true"
   * @generated
   */
  string_nova getString();

  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.myDsl.primary_expression#getString <em>String</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setString(string_nova value);
