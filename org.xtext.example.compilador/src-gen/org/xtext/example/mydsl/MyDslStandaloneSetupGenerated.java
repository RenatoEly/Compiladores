...
public class MyDslStandaloneSetupGenerated implements ISetup {
	...
	public void register(Injector injector) {
		...
		Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put("compi2", resourceFactory);
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("compi2", serviceProvider);
	}
}
